...
@interface QYZUrlRouteData()

//@property(nonatomic,strong) QYZUrlRouteMapping *routeMapping;

@end

@implementation QYZUrlRouteData

+(QYZUrlRouteData *)sharedData {
    
    static QYZUrlRouteData *urlRouteData = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        urlRouteData = [[QYZUrlRouteData alloc]init];
    });
...
-(UIViewController *)findVCWithUrlKey:(NSString *)key extraParams:(NSDictionary *)extraParams {
    ...
    Class class = [[QYZUrlRouteData sharedData] classFromUrlKey:key];
...
-(NSString *)classNameWithKey:(NSString *)key {
    ...
    return [QYZUrlRouteMapping shareInstance].mappingData[classNameKey] ? : classNameKey;
}
